...
const FAQAccordion = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const data = {
            access_key: "f77f930f-c45b-437a-abd1-f021ec73e813", // Replace with your actual Web3Forms key
            subject: "New Contact Form Submission - FAQ Section",
            from_name: "Company Website FAQ",
            botcheck: false,
    ...
    return (
        <section className="bg-white py-20 px-6 md:px-12">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-start">
                ...
                <div className="relative bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-[#19CAB7]/30 lg:w-1/2 w-full overflow-hidden">
